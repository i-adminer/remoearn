    ...
    <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
        ...
        <form onSubmit={handleSubmit} className="relative space-y-5 p-6 sm:p-8">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <label className="space-y-2">
              ...
              <input
                name="name"
                required
                placeholder="Among'a Onuong'a"
                className="h-12 w-full rounded-2xl border border-border/70 bg-background px-4 text-sm outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/20 dark:border-white/10 dark:bg-white/5"
              />
            </label>
            <label className="space-y-2">
          ...
          <label className="block space-y-2">
            ...
            <textarea
              ...
              className="w-full rounded-3xl border border-border/70 bg-background px-4 py-3 text-sm outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/20 dark:border-white/10 dark:bg-white/5"
            />
          </label>
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            {submitted ? (
              <p className="text-sm text-muted-foreground">Opening your email app...</p>
            ) : (
              <p className="text-sm text-muted-foreground">Usually answered within 24 hours.</p>
            )}
          </div>
        </form>
      </MarketingCard>
      ...
      <MarketingCard className="space-y-6 border border-border/70 bg-background/90 p-6 shadow-[0_20px_70px_-40px_rgba(15,23,42,0.35)] backdrop-blur dark:border-white/10 dark:bg-white/5">
        <div>
          ...
          <h3 className="mt-3 text-2xl font-semibold tracking-tight">Simple, direct, and responsive</h3>
        </div>

        <div className="space-y-3">
          <SupportItem icon={Mail} title="Email" value={supportEmail} />
          <SupportItem icon={MessageSquareText} title="Response time" value="Within 24 hours" />
          <SupportItem icon={PhoneCall} title="Use cases" value="Orders, downloads, partnerships" />
        </div>

        <div className="rounded-3xl border border-border/70 bg-secondary/40 p-4 dark:border-white/10 dark:bg-white/5">
          <p className="text-sm font-medium text-foreground">Need a faster answer?</p>
          <p className="mt-2 text-sm leading-7 text-muted-foreground">
            Include your order email and product name so we can resolve it faster.
          </p>
        </div>
      </MarketingCard>
    </div>
...
function SupportItem({
  ...
  return (
    <div className="flex items-center gap-3 rounded-3xl border border-border/70 bg-background px-4 py-3 dark:border-white/10 dark:bg-white/5">
      <span className="flex size-10 items-center justify-center rounded-2xl bg-primary/10 text-primary dark:bg-white/10 dark:text-white">
