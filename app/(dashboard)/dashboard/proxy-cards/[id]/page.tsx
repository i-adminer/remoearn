...
export default async function EditProxyCardPage({ 
  ...
  const card = await db.collection<ProxyCard>(Collections.PROXY_CARDS)
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold tracking-tight">Edit Proxy Card</h1>
        <p className="text-sm text-muted-foreground mt-1">Update card details</p>
      </div>
